...
Every figure named below can be regenerated by re-running the analysis that produced it. Static figures live in `outputs/figures/*.png` (light mode) and `dark_mode_plots/figures/*.png` (dark mode; see section 22.3).
