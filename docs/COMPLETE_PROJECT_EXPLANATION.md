...
The exploratory set ships twice: light-mode PNGs in `outputs/figures/` and a
dark-mode set in `dark_mode_plots/figures/` (20 committed static files). The
Vercel explorer's gallery draws the same set, mirrored under
`web/public/results/dark/`. The figures:
